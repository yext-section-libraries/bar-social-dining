...
type BarSocialDiningHeaderSectionProps = {
...
const BarSocialDiningHeaderSectionComponent: PuckComponent<
  BarSocialDiningHeaderSectionProps
> = (props) => {
...
export const BarSocialDiningHeaderSection: YextComponentConfig<BarSocialDiningHeaderSectionProps> =
  {
    ...
    render: (props) => (
      <AnalyticsScopeProvider
        name={`BarSocialDiningHeaderSection${getAnalyticsScopeHash(props.id)}`}
      >
        <BarSocialDiningHeaderSectionComponent {...props} />
      </AnalyticsScopeProvider>
    ),
  };
